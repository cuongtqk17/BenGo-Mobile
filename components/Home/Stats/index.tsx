      ...
      >
        <View className="flex-row justify-around">
          <View className="items-center">
            ...
            <Text className="text-2xl font-JakartaExtraBold text-primary-600">
              4.8
            </Text>
            <Text className="text-base text-secondary-600">Đánh giá TB</Text>
          </View>
          ...
          <View className="items-center">
            ...
            <Text className="text-base text-secondary-600">Đúng giờ</Text>
          </View>
          <View className="w-px bg-secondary-200" />
          <View className="items-center">
            <View className="mb-2">
            ...
            <Text className="text-base text-secondary-600">Hoạt động</Text>
          </View>
        </View>
      </View>
    </View>
